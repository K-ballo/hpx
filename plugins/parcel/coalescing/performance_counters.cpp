...
namespace hpx { namespace plugins { namespace parcel
{
    ...
    void startup()
    {
        ...
        generic_counter_type_data const counter_types[] =
        {
            ...
            { "/coalescing/count/parcels", counter_monotonically_increasing,
              ...
              HPX_MONOSTATE_FUNCTION(&num_parcels_counter_creator),
              HPX_MONOSTATE_FUNCTION(&counter_discoverer),
              ""
            },
            ...
            { "/coalescing/count/messages", counter_monotonically_increasing,
              ...
              "parameter",
              HPX_PERFORMANCE_COUNTER_V1,
              HPX_MONOSTATE_FUNCTION(&num_messages_counter_creator),
              HPX_MONOSTATE_FUNCTION(&counter_discoverer),
              ""
            },
            ...
            { "/coalescing/count/average-parcels-per-message",
              ...
              HPX_PERFORMANCE_COUNTER_V1,
              HPX_MONOSTATE_FUNCTION(&num_parcels_per_message_counter_creator),
              HPX_MONOSTATE_FUNCTION(&counter_discoverer),
              ""
            },
            ...
            { "/coalescing/time/between-parcels-average", counter_average_timer,
              ...
              HPX_PERFORMANCE_COUNTER_V1,
              HPX_MONOSTATE_FUNCTION(&average_time_between_parcels_counter_creator),
              HPX_MONOSTATE_FUNCTION(&counter_discoverer),
              "ns"
            },
            ...
            { "/coalescing/time/between-parcels-histogram", counter_histogram,
              ...
              HPX_PERFORMANCE_COUNTER_V1,
              HPX_MONOSTATE_FUNCTION(&time_between_parcels_histogram_counter_creator),
              HPX_MONOSTATE_FUNCTION(&counter_discoverer),
              "ns/0.1%"
            }
        };
        ...
        bool& pre_startup)
    {
        ...
        startup_func = HPX_MONOSTATE_FUNCTION(&startup);   // function to run during startup
