...
namespace hpx { namespace parallel { inline namespace v1 { namespace detail {
        ...
        std::size_t chunk_size)
    {
        ...
        sample_sort_helper_t sorter(HPX_FWD(comp), num_threads);
        sorter(HPX_FWD(exec), first, last, paux, naux, chunk_size);
    }
        ...
        std::uint32_t num_threads)
    {
        ...
        return sample_sort(HPX_FWD(exec), first, last,
            HPX_FWD(comp), num_threads, (value_type*) nullptr,
        ...
        std::size_t chunk_size = 0)
    {
        ...
        return sample_sort(HPX_FWD(exec), first, last,
            HPX_FWD(comp), num_threads, range_buf_initial.begin(),
        ...
        Exec&& exec, Iter first, Sent last, std::uint32_t num_threads)
    {
        ...
        return sample_sort(HPX_FWD(exec), first, last, compare{},
