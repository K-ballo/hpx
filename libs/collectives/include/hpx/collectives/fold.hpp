...
namespace hpx { namespace lcos {
        ...
        Ts const&... vs)
    {
        ...
        return hpx::detail::async_colocated<fold_impl_action>(ids[0], Action(),
            ids, HPX_FWD(fold_op), HPX_FWD(init), 0,
            vs...);
    }
    ...
    hpx::future<typename detail::fold_result<Derived>::type> fold(
        ...
        Ts const&... vs)
    {
        return fold<Derived>(ids, HPX_FWD(fold_op),
            HPX_FWD(init), vs...);
    }
        ...
        Ts const&... vs)
    {
        return fold<detail::fold_with_index<Action>>(ids,
            HPX_FWD(fold_op), HPX_FWD(init), vs...);
    }
        ...
        Ts const&... vs)
    {
        ...
        return hpx::detail::async_colocated<fold_impl_action>(inverted_ids[0],
            Action(), inverted_ids, HPX_FWD(fold_op),
            HPX_FWD(init),
    ...
    hpx::future<typename detail::fold_result<Derived>::type> inverse_fold(
        ...
        Ts const&... vs)
    {
        return inverse_fold<Derived>(ids, HPX_FWD(fold_op),
            HPX_FWD(init), vs...);
    }
