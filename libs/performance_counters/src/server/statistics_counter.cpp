...
namespace hpx { namespace performance_counters { namespace server {
    ...
    statistics_counter<Statistic>::statistics_counter(counter_info const& info,
      ...
      , timer_(util::bind_front(HPX_MONOSTATE_FUNCTION(&statistics_counter::evaluate), this_()),
            util::bind_front(HPX_MONOSTATE_FUNCTION(&statistics_counter::on_terminate), this_()),
